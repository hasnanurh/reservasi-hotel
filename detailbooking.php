...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="databooking.php" class="nav-item nav-link active ">Daftar Pesanan</a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Pemesanan</h6><br><br>
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <?php
                                ...
                                $query = mysqli_query($koneksi, "select *, tbl_jeniskamar.jenis_kamar from tbl_pesanan inner join tbl_jeniskamar on tbl_jeniskamar.id_jeniskamar = tbl_pesanan.id_jeniskamar where id_pesanan = '$id_pesanan' ");
                                $row = mysqli_fetch_array($query);
                            ?>
                            <form method="post" action="simpanpesanan.php">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label>Nama Pemesan</label>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" name="nama" value="<?php echo $row['nama_pemesan'] ; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>No Identitas</label>
                                        <div class="form-floating">
                                            <input type="number" value="<?php echo $row['no_identitas'] ; ?>" readonly class="form-control" name="identitas" >
                                        </div>
                                    </div>
                                </div><br>
                                <div class="row g-3">
                                   <div class="col-md-12">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" value="<?php echo $row['jenis_kelamin'] ; ?>" readonly class="form-control" name="identitas" >
                                        </div>
                                    </div>
                                  ...
                                  <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating">
                                           <input type="text" value="<?php echo $row['jenis_kamar'] ; ?>" readonly class="form-control" name="identitas" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Harga</label>
                                        <div class="form-floating">
                                            <input type="text" name="harga" value="<?php echo rupiah($row['harga']) ; ?>" readonly class="form-control" id="harga"  >
                                        </div>
                                    </div>
                                </div><br>   
                                   ...
                                   <div class="row">
                                         ...
                                         <div class="col-6">  <label for="message">Durasi Menginap</label>
                                        <div class="form-floating">
                                             <input type="number" value="<?php echo $row['durasi'] ; ?>" readonly id="durasi" name="durasi" class="form-control" >
                                        </div>
                                        </div>
                                        <div class="col-6">  <label for="message">Diskon</label>
                                        <div class="form-floating">
                                             <input type="text" value="<?php echo $row['diskon'] ; ?> %" readonly id="durasi" name="durasi" class="form-control" >
                                        </div>
                                    </div>
                               </div>
                                   <br>
                                   <div class="row">
                                        <div class="col-6">  <label for="message">Total Bayar</label>
                                        <div class="form-floating">
                                             <input type="text" id="totalbayar"  value="<?php echo rupiah($row['total_bayar']) ; ?>" readonly name="totalbayar" class="form-control" >
                                             <input type="hidden" id="diskon"  readonly name="diskon" class="form-control" >

                                             <input type="hidden" id="diskon1"  readonly name="diskon1" class="form-control" >
    ...
    <script type="text/javascript">
        function hitung(){
            ...
            if(durasi > 3){
                 var discount = durasi * harga * diskon;
                 var hasil= durasi * harga - discount ;
