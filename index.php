...
<body>
    <div class="container-xxl bg-white p-0">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px;">
                                <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Ruang Loby</h6>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Pilihan Jenis <span class="text-primary text-uppercase">Kamar</span></h1>
                </div>
                <div class="row g-4">
                    <?php
                      include 'koneksi.php';
                      include 'rupiah.php';
                      $data = mysqli_query ($koneksi, "select * from tbl_jeniskamar");
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0"><?php echo $row['jenis_kamar']; ?></h5>
        ...
        <!-- Testimonial Start -->
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Testimoni</h6>
                    <h1 class="mb-5">Daftar Testimoni</span></h1>
                </div>
                        ...
                        <div class="rounded shadow overflow-hidden">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-50 top-100 translate-middle d-flex align-items-center">
                                    ...
                                    <a class="btn btn-square btn-primary mx-1" href="https://twitter.com"><i class="fab fa-twitter"></i></a>
